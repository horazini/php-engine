...
Energía: <br>Combinación de parámetros (variables de estado, generalmente velocidad, posición, masa, etc.) que se transfieren de un cuerpo a otro por causa de las fuerzas, permaneciendo constantes en el sistema a través del tiempo.
<br><br>
...
Las ecuaciones de evolución de los sistemas son independientes del instante de tiempo considerado, es decir, son las mismas en cada instante del tiempo (las leyes de la física no cambian con el tiempo). 
Eso conduce a que la "traslación" temporal sea una simetría que deja invariante las ecuaciones de evolución del sistema, por lo que existe una magnitud conservada, la energía.
<br><br>
...
En una colisión, los átomos de cada objeto se repelen por la fuerza electromagnética, entonces en vez de que un objeto traspase al otro, estos colisionan debido a la repulsión eléctrica entre los electrones orbitando cada nucleo.
<br><br>

Fuerza química:<br>
La fuerza electromagnética es responsable de los enlaces químicos entre los átomos que crean moléculas y fuerzas intermoleculares. 
La fuerza electromagnética gobierna todos los procesos químicos, que surgen de las interacciones entre los electrones de los átomos vecinos.
<br><br>
...
Diferencia entre la energía del elemento y la energía del mismo número de protones y neutrones consideradas individualmente.
Se puede medir por la cantidad mínima de energía necesaria para descomponer el núcleo en sus protones y neutrones separados.
La energía emitida durante la fusión o fisión nuclear es la diferencia entre las energías de enlace del «combustible», es decir, el nucleido inicial (s), y los productos de fusión o fisión.
<br><br>
La fórmula de Einstein implica que una gran cantidad de energía puede ser liberada por la reacción de fisión nuclear en cadena. Es usada tanto en producción de energía atómica como en armas nucleares.
<br>
Reacción de fisión: 
...
Se divide en elementos más ligeros que se despiden rapidamente y libera varios neutrones, así como rayos gamma.
	No entiendo si los rayos gamma son producto inherente de la fisión (separación) o de las sucesivas fusiones en cadena, 
...
<br><br>
En todo procesos termodinámicos macroscópicos existe una cantidad de energía que se "disipa" (no se pierde), o sea, que escapa al super-sistema del que es sub-sistema ese proceso, dejando al subsistema en un estado de equilibrio.
Ejemplo: Una olla con agua hirviendo, el sistema esta fuertemente desequilibrado, pero el calor inevitablemente escapa al ambiente donde se encuentra la olla, ahora el ambiente esta ligeramente desequilibrado, y la olla se acerca a un estado de equilibrio...
<br><br>
Los sistemas complejos o autoorganizados, por ejemplo los seres vivos, se caracterizan por la autopoiesis, que permite su existencia en el tiempo. Sin embargo esta autopoiesis es sostenible ya que la vida en la tierra dispone de una fuente constante de energía: el sol.
Las estrellas, cuya causa es la fuerza de la gravedad (atracción de materia a un punto) y de la nuclear (emisión de radiación electromagnética) tienen, según el modelo actual, un destino final inevitable, al alcanzar un punto de equilibrio (perdida de combustible nuclear) donde se vuelven inhertes y ya no pueden sostener a la vida.
<br><br>
...
<br><br>
Muchos procesos son matemáticamente reversibles en su microestado cuando se analizan utilizando la mecánica newtoniana clásica.
Esta paradoja claramente contamina las explicaciones microscópicas de la tendencia macroscópica hacia el equilibrio, como el argumento de 1860 de James Clerk Maxwell de que las colisiones moleculares implican una igualación de temperaturas de gases mixtos.
<br><br>
De 1872 a 1875, Ludwig Boltzmann reforzó la explicación estadística de esta paradoja en la forma de la fórmula de entropía de Boltzmann, afirmando que un aumento en el número de posibles microestados en los que podría estar un sistema aumentará la entropía del sistema, haciendo menos probable que el sistema volverá a un estado anterior. 
...
La energia interna de un sistema es igual al calor añadido (energía de entrada) menos el trabajo realizado (energía de salida).
<br><br>
Segundo principio de la termodinámica (Irreversibilidad de los procesos naturales):
<br><br>
La irreversibilidad de los procesos naturales y la tendencia de los procesos naturales a conducir a la homogeneidad de la materia y energía (especialmente de la temperatura) implica la existencia de una cantidad llamada "entropía" de un sistema termodinámico.
...
<br><br>
El principio afirma que, para dos estados macroscópicamente especificados de un sistema, hay una cantidad llamada "diferencia de entropía de la información" entre ellos. 
Esta diferencia de entropía de información define la forma en que se necesita la información microscópica adicional tanto para especificar uno de los estados macroscópicamente, dada la especificación macroscópica de la otra - a menudo un estado de referencia convenientemente elegido se puede presuponer que existe en lugar de que se indique expresamente. 
Una condición final de un proceso natural siempre contiene efectos microscópicamente especificables que no son totalmente y exactamente predecibles a partir de la especificación macroscópica de la condición inicial del proceso. 
Esta es la razón por la que la entropía incrementa en un proceso natural - el incremento nos dice cómo se necesita mucha información extra microscópica para distinguir el estado microscópicamente final especificado desde el macroestado inicial dado.
<br><br>
xxxxxxxxxxxxxx
<br><br>
...
En ese momento, aún no había aparecido la idea de que un gas estuviera compuesto por moléculas diminutas y que la temperatura representara su energía cinética promedio.
Fue Rudolph Clausius quien primero avanzó explícitamente la idea de la entropía.
(On Different Forms of the Fundamental Equations of the Mechanical Theory of Heat, 1865; The Mechanical Theory of Heat, 1867). 
<br><br>
...
<br><br>
Carnot y Clausius pensaron en el calor como una especie de fluido, una cantidad conservada que se movía de un sistema a otro.
